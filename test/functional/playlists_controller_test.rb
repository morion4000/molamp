...
class PlaylistsControllerTest < ActionController::TestCase
  ...
  test "should create playlist" do
    assert_difference('Playlist.count') do
      post :create, :playlist => { :author => @playlist.author, :body => @playlist.body, :title => @playlist.title }
    end
  ...
  test "should update playlist" do
    put :update, :id => @playlist, :playlist => { :author => @playlist.author, :body => @playlist.body, :title => @playlist.title }
    assert_redirected_to playlist_path(assigns(:playlist))
  end
